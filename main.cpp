...
void Logger(){
      ...
      // d = a*t^2/2  a = 9.8*t[i] d = 9.8*t[i]*t^2/2
      distence = 9.8*t[1]/2;
      if(tol_dis*distence >= 0){
          tol_dis = tol_dis + distence;
      }
      else tol_dis = 0;
      ...
      log1[i] =std::to_string(t[0]) + " " + std::to_string(t[1]) +" " + std::to_string(t[2]) + " " + std::to_string(larger5) + "\r\n";
